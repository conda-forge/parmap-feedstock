...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/parmap-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6789&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/parmap-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `parmap` can be installed with:

```
conda install parmap
```

It is possible to list all of the versions of `parmap` available on your platform with:
